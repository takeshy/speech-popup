...
globalThis.window.go = {
  main: {
    App: {
      ...
      StartLiveSpeech: () => call("StartLiveSpeech"),
      SendLiveSpeechAudio: (sessionId, audio) => call("SendLiveSpeechAudio", sessionId, audio),
      FinishLiveSpeech: (sessionId) => call("FinishLiveSpeech", sessionId),
      StopLiveSpeech: () => call("StopLiveSpeech"),
